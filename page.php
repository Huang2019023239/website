...
<td width="63%" align="right"><?php
    echo "<a href=page.php?page=1><button>Fist Page</button></a>&nbsp;";
    echo "<a href=page.php?page=".($page-1)."><button>Page Up</button></a>&nbsp;";
    echo "<a href=page.php?page=".($page+1)."><button>Page Down</button></a>&nbsp;";
    echo "<a href=page.php?page=".$page_count."><button>Last Page</button></a>&nbsp;";
